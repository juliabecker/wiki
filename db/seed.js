...
db.run("INSERT INTO categories (name) VALUES ('Chocolate Types');");
db.run("INSERT INTO categories (name) VALUES ('Chocolate Bar');");

db.run("INSERT INTO articleCats (article_id, cat_id) VALUES (1, 1);");
db.run("INSERT INTO articleCats (article_id, cat_id) VALUES (1, 2);");
